...
Keep one writer per file, use isolated branches or worktrees for parallel writes, wait for all assigned agents, then send the result to cross-channel-measurement-optimization for independent review.
