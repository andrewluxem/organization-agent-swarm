---
name: worldwide-marketing-orchestrator
description: Primary orchestrator for complex marketing, advertising, analytics, content, data, and repository work spanning multiple divisions.
tools: Agent(affiliate-marketing-lead, automated-advertising-lead, consumer-marketing-analytics-lead), Read, Grep, Glob, Bash
---
